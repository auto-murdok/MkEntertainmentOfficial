...
{
    private const string SourceScenePath = "Assets/Scenes/ZombieCombatArena.unity";
    private const string TargetScenePath = "Assets/Scenes/ExpandedCombatArena.unity";
    private const string BlueMatPath = "Assets/StarterAssets/Environment/Art/Materials/GridBlue_01_Mat.mat";
    private const string OrangeMatPath = "Assets/StarterAssets/Environment/Art/Materials/GridOrange_01_Mat.mat";
    ...
    public static void GenerateScene()
    {
        ...
        GameObjectUtility.SetStaticEditorFlags(floor, StaticEditorFlags.BatchingStatic | StaticEditorFlags.OccludeeStatic | StaticEditorFlags.OccluderStatic | StaticEditorFlags.NavigationStatic);
    ...
    private static GameObject CreateWall(Transform parent, string name, Vector3 pos, Vector3 scale, Material mat)
    {
        ...
        GameObjectUtility.SetStaticEditorFlags(wall, StaticEditorFlags.BatchingStatic | StaticEditorFlags.OccludeeStatic | StaticEditorFlags.OccluderStatic | StaticEditorFlags.NavigationStatic);
        return wall;
    }
    ...
    private static GameObject CreateCoverBox(Transform parent, string name, Vector3 pos, Vector3 scale, Quaternion rot, Material mat)
    {
        ...
        GameObjectUtility.SetStaticEditorFlags(box, StaticEditorFlags.BatchingStatic | StaticEditorFlags.OccludeeStatic | StaticEditorFlags.OccluderStatic | StaticEditorFlags.NavigationStatic);
        return box;
    }
    ...
    private static GameObject CreatePillar(Transform parent, string name, Vector3 pos, Vector3 scale, Material mat)
    {
        ...
        GameObjectUtility.SetStaticEditorFlags(cylinder, StaticEditorFlags.BatchingStatic | StaticEditorFlags.OccludeeStatic | StaticEditorFlags.OccluderStatic | StaticEditorFlags.NavigationStatic);
        return cylinder;
    }
